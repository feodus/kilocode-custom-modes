...
Skill for comprehensive Python testing using pytest framework. Covers unit testing, integration testing, test organization, mocking, and CI/CD integration. Essential for QA engineers working with Python applications.

## When to Use

Use this skill:
- When creating unit tests for Python applications
- For integration and end-to-end testing
- When mocking external dependencies
- For setting up automated testing in CI/CD pipelines
...
- test-automation-frameworks — automation frameworks (Selenium, Cypress, Playwright)
- api-testing — API testing strategies
- test-case-design — designing test cases
- test-data-management — managing test data
- gherkin-specifications — BDD testing with Gherkin

---
*Python Testing — ensuring quality of Python applications through systematic testing*
