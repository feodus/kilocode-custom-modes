...
# Test Case Design for Quality Assurance
...
Use this skill:
- When designing testing strategies and approaches
- For creating test documentation based on requirements
...
- When executing testing activities
